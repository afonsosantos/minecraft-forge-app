...
function start() {
    ...
    minecraft = require('child_process').spawn('java', [`-Xmx${memoryLimit}M`, `-Xms${memoryLimit}M`, `@/app/code/forge/libraries/net/minecraftforge/forge/1.17.1-37.1.1/unix_args.txt`, 'nogui', `"$@"`], opts);
