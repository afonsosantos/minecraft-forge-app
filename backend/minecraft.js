...
function start() {
    ...
    minecraft = require('child_process').spawn('java', [`-Xmx${memoryLimit}M`, `-Xms${memoryLimit}M`, `@/app/code/forge/libraries/net/minecraftforge/forge/1.16.5-36.2.34/unix_args.txt`, 'nogui', `"$@"`], opts);
